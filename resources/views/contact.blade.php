    ...
    <header class="flex justify-between items-center py-6 px-6 md:px-20 bg-[#262626] fixed top-0 left-0 w-full z-50">
        ...
        <nav class="nav-center hidden lg:flex items-center gap-10">
            ...
            <a href="{{ route('contact') }}"
                class="font-bold text-lg text-white relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-[#7D3E35]">Contact</a>
        </nav>
    ...
    <main class="container mx-auto px-4 md:px-20 py-8 mt-20 pt-20 mb-10 pb-10">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/2 h-96 bg-gray-100 rounded-lg overflow-hidden shadow-md">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.671827156563!2d107.5924892750438!3d-6.929772293070052!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e900f1bf11cd%3A0x2264f939b55bcda6!2sBuns%20Ceramics%20Home%20Studio!5e0!3m2!1sid!2sid!4v1747137595664!5m2!1sid!2sid"
            ...
            <div class="w-full lg:w-1/2 space-y-4">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 ml-8 text-sm">Gang Bbk Asih No. 376/198A, Kota Bandung, Jawa Barat 40232,
                        Indonesia</p>
                </div>
            </div>
        </div>
