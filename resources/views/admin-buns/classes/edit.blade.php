            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-800 text-white">
                        <th colspan="2" class="text-left p-4 font-semibold">Informasi Kelas</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Nama Kelas -->
                    ...
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="p-4">
                            <div class="border-2 border-dashed border-gray-300 rounded-md p-4 text-center">
                                ...
                                <div id="currentImageContainer" class="{{ $langganan->gambar_subs ? '' : 'hidden' }} mb-3">
                                    <img id="currentImage" src="{{ asset('storage/langganan_images/' . $langganan->gambar_subs) }}"
                                ...
                                <!-- Hapus Gambar Button -->
                                <div id="changeImageButtonContainer" class="{{ $langganan->gambar_subs ? '' : 'hidden' }} mt-3">
                        ...
                        <td class="p-4">
                            <div id="benefitListEdit" class="max-h-[150px] overflow-y-auto space-y-2 rounded-md p-2">
                                ...
                                <div class="flex items-center gap-2 mb-2">
                                    <input type="text" name="benefit_subs[]" value="{{ $benefit }}" required
                            ...
                            <button type="button" onclick="addBenefitEdit()" class="mt-2 flex items-center text-blue-600 hover:text-blue-800">
