...
<section id="users" class="bg-light py-5">
    <div class="container">
        ...
        <div class="action-bar mb-4">
            <div class="action-right">
                <form action="{{ route('admin-buns.users.index') }}" method="GET" class="search-form-modern">
                ...
                <table class="table custom-table">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="item-name">{{ optional($account->member)->nama_member ?? 'N/A' }}</td>
                            <td>{{ optional($account->member)->email_member ?? $account->email }}</td>
                            <td>{{ optional($account->member)->no_telp ?? 'N/A' }}</td>
                            <td>
                                @if(strtolower($account->role) == 'admin')
                                <span class="badge-role admin">Admin</span>
                                @elseif(strtolower($account->role) == 'member')
                                <span class="badge-role member">Member</span>
                                @else
                                <span class="badge-role other">{{ ucfirst($account->role) }}</span>
                                @endif
                            </td>
                        </tr>
                        @empty
