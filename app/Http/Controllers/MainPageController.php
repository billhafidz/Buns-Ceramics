...
class MainPageController extends Controller
{
    public function index()
    {
        $langganans = Langganan::select('langganans.*', DB::raw('COUNT(transactions.id) as purchase_count'))
            ...
            ->where('langganans.status', 'active') 
            ->groupBy(
                'langganans.id_langganan',
                'langganans.pilihan_subs',
                'langganans.penjelasan_subs',
                'langganans.benefit_subs',
                'langganans.harga_subs',
                'langganans.gambar_subs',
                'langganans.created_at',
                'langganans.updated_at',
                'langganans.status'
            )
